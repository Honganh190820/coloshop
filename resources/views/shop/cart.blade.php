    ...
    <div style="margin-top: 20px;" class="container contact_container" id="my_cart">
        ...
        @if(session('cart'))
            ...
            <form style="width: 1000px" action="{{ route('shop.cart.checkout') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4">
                        <input class="form_input input_name input_ph" type="text"  id="fullname" name="fullname" value="" placeholder="Name" >
                        @if ($errors->has('fullname'))
                            <span class="invalid-feedback" role="alert" style="color:red;">{{ $errors->first('fullname') }}</span>
                        @endif
                        <input id="input_email" class="form_input input_phone input_ph" type="text" name="phone" placeholder="Phone">
                    ...
                    <div class="col-6">
                        ...
                        @if ($errors->has('email'))
                            <span class="invalid-feedback" role="alert" style="color:#e30e0e;">{{ $errors->first('email') }}</span>
                        @endif
                        <textarea id="input_content" class="input_ph input_message" name="note"  placeholder="content" rows="3"></textarea>
